...
export function iniciarVisorDibujos(anio, data) {
  const lista = data.drawings[anio];
...
function crearLightbox() {
  ...
  fondo.style.backgroundColor = 'rgba(220, 220, 220, 0.98)';  // menos transparencia
  ...
  img.style.maxHeight = '80vh';  // imagen más grande
  ...
  flechaIzq.style.left = '-40px';
  flechaIzq.style.fontSize = '2em';
  ...
  flechaDer.style.right = '-40px';
  flechaDer.style.fontSize = '2em';
  ...
  const flechaIzq = document.createElement('div');
    flechaIzq.innerHTML = '&#10094;'; // HTML code for ‹
    flechaIzq.style.position = 'absolute';
    flechaIzq.style.top = '50%';
...
const flechaDer = document.createElement('div');
  flechaDer.innerHTML = '&#10095;'; // HTML code for ›
  flechaDer.style.position = 'absolute';
  flechaDer.style.top = '50%';
